...
namespace BS_PP_BOOSTER
{
    ...
    {
        private static System.Reflection.FieldInfo AccessPlatformUserModel;
        ...
        static GetUserInfo()
        {
            try
            {
                   AccessPlatformUserModel = typeof(PlatformLeaderboardsModel).GetField("_platformUserModel", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
            }
            catch (Exception ex)
            {
        ...
        internal static IPlatformUserModel SetPlatformUserModel()
        {
            ...
            try
            {
                ...
                var leaderboardsModel = Resources.FindObjectsOfTypeAll<PlatformLeaderboardsModel>().Where(p => AccessPlatformUserModel.GetValue(p) != null).FirstOrDefault();
                ...
                platformUserModel   = AccessPlatformUserModel.GetValue(leaderboardsModel) as IPlatformUserModel;
